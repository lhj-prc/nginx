...
static ngx_int_t ngx_ssl_stapling_certificate(ngx_conf_t* cf, ngx_ssl_t* ssl, X509* cert,
...
static ngx_int_t ngx_ssl_ocsp_responder(ngx_connection_t* c, ngx_ssl_ocsp_ctx_t* ctx)
{
    char*                      s;
    ngx_str_t                  responder;
    ngx_url_t                  u;
...
static void ngx_ssl_ocsp_error(ngx_ssl_ocsp_ctx_t* ctx)
{
    ngx_log_debug0(NGX_LOG_DEBUG_EVENT, ctx->log, 0,
                   "ssl ocsp error");
