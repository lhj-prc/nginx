...
static int ngx_stream_ssl_servername(ngx_ssl_conn_t* ssl_conn, int* ad, void* arg)
{
...
static int ngx_stream_ssl_alpn_select(ngx_ssl_conn_t* ssl_conn, const unsigned char** out,
...
static char* ngx_stream_ssl_alpn(ngx_conf_t* cf, ngx_command_t* cmd, void* conf)
{
#ifdef TLSEXT_TYPE_application_layer_protocol_negotiation
...
static char* ngx_stream_ssl_conf_command_check(ngx_conf_t* cf, void* post, void* data)
{
